...
function Profile() {
  ...
  return (
    <div className='min-h-screen bg-gray-500 px-4 py-10 flex items-center justify-center'>
      
      <div className='bg-white shadow-lg rounded-2xl p-8 max-w-xl w-full relative'>
        <FaArrowLeft  className='absolute top-[8%] left-[5%] w-[22px] h-[22px] cursor-pointer active:bg-[#4b4b4b] transition' onClick={()=>navigate("/")}/>
